    ...
    const translations = {
        es: {
            ...
            interface: {
                ...
                reservationTagline: "Reserva tu mesa en Raíces Gran Tarajal.",
                reservationPending: "No se ha podido conectar con el servicio de reservas. Inténtalo de nuevo más tarde.",
                reservationSending: "Enviando tu solicitud de reserva...",
                reservationSuccess: "Solicitud enviada correctamente. Te contactaremos para confirmarla.",
                reservationError: "No se ha podido enviar la solicitud. Comprueba tu conexión e inténtalo de nuevo.",
                reservationClosedDays: "El restaurante está cerrado martes y miércoles. Elige de jueves a lunes.",
                home: "Inicio",
                ...
                viewFish: "Ver pescados",
                freshFish: "Pescados frescos del día",
                fishCatalogEmpty: "Aquí aparecerán los pescados disponibles del día.",
                viewFishDetails: "Ver pescado",
                openFish: "Ver detalles de {name}",
        ...
        en: {
            ...
            interface: {
                ...
                viewFish: "View fish",
                freshFish: "Fresh fish of the day",
                fishCatalogEmpty: "The fish available today will appear here.",
                viewFishDetails: "View fish",
                openFish: "View details for {name}",
                fishImageLabel: "Fish",
                plateImageLabel: "Presented dish",
                backToFishList: "Back to fish",
                closeFishCatalog: "Close fish catalogue",
        ...
        de: {
            ...
            interface: {
                ...
                viewFish: "Fisch ansehen",
                freshFish: "Frischer Fisch des Tages",
                fishCatalogEmpty: "Die heute verfügbaren Fische werden hier angezeigt.",
                viewFishDetails: "Fisch ansehen",
                openFish: "Details zu {name} ansehen",
                fishImageLabel: "Fisch",
                plateImageLabel: "Serviertes Gericht",
                backToFishList: "Zurück zu den Fischen",
                closeFishCatalog: "Fischkatalog schließen",
        ...
        it: {
            ...
            interface: {
                ...
                viewFish: "Vedi pesci",
                freshFish: "Pesce fresco del giorno",
                fishCatalogEmpty: "I pesci disponibili oggi appariranno qui.",
                viewFishDetails: "Vedi pesce",
                openFish: "Vedi i dettagli di {name}",
                fishImageLabel: "Pesce",
                plateImageLabel: "Piatto presentato",
                backToFishList: "Torna ai pesci",
                closeFishCatalog: "Chiudi il catalogo dei pesci",
        ...
        fr: {
            ...
            interface: {
                ...
                viewFish: "Voir les poissons",
                freshFish: "Poissons frais du jour",
                fishCatalogEmpty: "Les poissons disponibles aujourd’hui apparaîtront ici.",
                viewFishDetails: "Voir le poisson",
                openFish: "Voir les détails de {name}",
                fishImageLabel: "Poisson",
                plateImageLabel: "Plat présenté",
                backToFishList: "Retour aux poissons",
                closeFishCatalog: "Fermer le catalogue de poissons",
